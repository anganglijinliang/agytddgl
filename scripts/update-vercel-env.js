...
NEXTAUTH_URL=https://agytddgl-mtkhys6t-anganglijinliang-s-team.vercel.app
SKIP_DB_SYNC=true
...
console.log('已创建 .env.vercel 文件，包含更新的Vercel环境变量');

// 输出关键信息供用户设置
console.log('\n在Vercel中设置以下关键环境变量:');
console.log('NEXTAUTH_SECRET=+P5qXGcf8ZiuXSgs4Wyv4rXHGPGJqiLAFVsgqRwp0wE=');
console.log('NEXTAUTH_URL=https://agytddgl-mtkhys6t-anganglijinliang-s-team.vercel.app');
